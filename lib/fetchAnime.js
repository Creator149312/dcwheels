...
export async function fetchAnime({
  ...
  const res = await fetch("https://graphql.anilist.co", {
    ...
    // Cache identical AniList GraphQL POSTs at the Vercel data layer for
    // 24h. Anime metadata is effectively static at the day-grain; this stops
    // every /anime/* render from hitting the upstream API.
