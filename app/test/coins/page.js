...
export default function CoinTracker() {
  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center p-6 overflow-hidden relative">
      ...
      <h1 className="text-5xl font-extrabold mb-6 text-black drop-shadow-lg">Coin Tracker</h1>
      <div
        id="character"
      ...
      <div className="text-3xl mb-4 text-black flex items-center" id="coin-display">
        <FaCoins className="mr-2" /> Coins: {coins}
      </div>
      <div className="text-2xl mb-4 text-black">Level: {level}</div>
      ...
      <div className="mt-6">
        <h2 className="text-2xl font-bold mb-2 text-black">Achievements:</h2>
