...
import { FaThumbsUp, FaThumbsDown, FaPlay, FaPause, FaExpand } from "react-icons/fa";

export default function WheelPlayerPanel({ title = "Sample Wheel", wheelCanvasId = "wheelCanvas" }) {
  ...
  return (
    ...
    >
      ...
      <div className="aspect-square bg-gray-100 dark:bg-gray-800 rounded-lg flex items-center justify-center">
        <canvas id={wheelCanvasId} className="w-full h-full"></canvas>
      </div>
